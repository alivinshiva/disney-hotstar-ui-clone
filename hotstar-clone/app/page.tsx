    ...
    <main className="">
      ...
      <footer >
        <p className="text-base lg:text-xl md:text-xl text-gray-500 mt-4 mb-4 text-center">
          ...
          <br />
          copyright &copy; hotstar-clone-alivin-jet.vercel.app All rights reserved!
        </p>
